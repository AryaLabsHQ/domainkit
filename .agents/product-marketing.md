...
_Last updated: 2026-09-02_ · _Current public stage: open-source packages at 0.8.0; optional CapsuleDB persistence is published at 0.1.2; hosted documentation is live_
...
- **Organization connection:** an owner-scoped link to a provider authorization.
- **Domain attachment:** an exact provider target bound to one organization connection and domain.
...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------- | ---------- | ------------------------ |
| `domainkit` and `@domainkit/react` latest npm versions are `0.8.0`                 | npm registry readback                                                  | `npm view domainkit`; `npm view @domainkit/react`                                                  | 2026-09-02    | Public web and package docs                    | high       | Maintainer               |
| `@domainkit/capsuledb` latest npm version is `0.1.2`                               | npm registry readback                                                  | `npm view @domainkit/capsuledb`; `npm view capsuledb`                                              | 2026-09-02    | Public web and package docs                    | high       | Maintainer               |
...
| React lifecycle events are part of the current 0.8.0 package                       | Published package, source, and artifact tests                          | `packages/react/src/lifecycle.ts`; `packages/react/package.json`                                   | 2026-09-02    | Public technical surfaces                      | high       | React package maintainer |
| DomainKit reduces customer setup friction                                          | Product intent and implemented flow; no current usability study        | Current landing page and React component catalog                                                   | 2026-08-31    | Directional headline only; no quantified claim | medium     | Product owner            |
...
| --------------------- | ------ | --------------------------------- | -------------------------------------------- |
| npm core package      | active | `domainkit@0.8.0`                 | Latest public core package                   |
| npm React package     | active | `@domainkit/react@0.8.0`          | Latest public React package                  |
| npm CapsuleDB package | active | `@domainkit/capsuledb@0.1.2`      | Optional Effect-native persistence package   |
