...
<CardGroup cols={2}>
  ...
  <Card title="DomainKit and Domain Connect" href="/docs/core/domain-connect" icon="link">
    Understand when provider templates are enough and when your SaaS needs an owned DNS lifecycle.
  </Card>
...
| `domainkit/server`  | Mountable connection routes backed by host-provided Layers               |
