...
description: Compose DomainKit React parts with Base UI render props, host-owned icons and provider marks, messages, and CSS design tokens.
---
...
## Build a records table from parts
