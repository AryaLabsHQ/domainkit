...
The [component catalog](/components) owns component installation, examples, states, accessibility,
and API details. The pages here explain package-wide integration choices and the host transport.
