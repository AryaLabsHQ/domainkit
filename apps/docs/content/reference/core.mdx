---
title: Core API
description: Reference the namespaces exported by DomainKit's canonical Effect entry point, including plans, providers, transport, and DNS verification.
sidebar:
  label: Core API
seo:
...
[Provision and clean up DNS](/docs/guides/provision-and-clean-up) for lifecycle semantics. See
[Entry points](/docs/reference/entry-points) when choosing the runtime boundary.
