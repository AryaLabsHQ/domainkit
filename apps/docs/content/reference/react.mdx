---
title: React API
description: Reference the namespaces exported by @domainkit/react, including complete flows, semantic parts, transport, and theming.
sidebar:
  label: React API
seo:
...
Component-specific props, examples, installation commands, states, and accessibility guidance live
on each page in the [React component catalog](/components). This page remains the package-level
namespace and runtime reference.
