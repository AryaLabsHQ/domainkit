---
title: Testing API
description: Reference DomainKit's in-memory services and provider conformance helpers for deterministic lifecycle and adapter tests.
sidebar:
  label: Testing API
seo:
...
| `InMemoryManagedDnsConnections`   | Durable-in-process managed connection repository for lifecycle tests.                    |
