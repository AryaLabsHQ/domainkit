...
export const User = S.Struct({ id: S.String, name: S.NullOr(S.String), username: S.String });
export const UserEnvelope = S.Struct({ user: User });

export const Team = S.Struct({ id: S.String, name: S.NullOr(S.String), slug: S.String });
export const TeamListEnvelope = S.Struct({ pagination: Pagination, teams: S.Array(Team) });
...
export const DomainListEnvelope = S.Struct({ domains: S.Array(Domain), pagination: Pagination });
...
export const CreateRecordEnvelope = S.Struct({ uid: S.String, updated: S.optionalKey(S.Number) });
