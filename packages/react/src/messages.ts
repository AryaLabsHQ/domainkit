...
export const english: Catalog = {
  applyCleanup: "Delete these DNS records",
  applyDns: "Apply DNS changes",
  applyingDns: "Applying DNS changes…",
  ...
  cleaningDns: "Deleting DNS records…",
  ...
  disconnectDomain: "Disconnect domain and keep DNS",
  disconnecting: "Disconnecting domain…",
  ...
  reviewCleanup: "Review DNS cleanup",
  reviewDns: "Review DNS changes",
  retry: "Try again",
